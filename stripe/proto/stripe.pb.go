...
var file_proto_stripe_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x07, 0x61, 0x6d, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xba, 0x02, 0x0a, 0x06, 0x53,
	...
	0x73, 0x65, 0x12, 0x43, 0x0a, 0x0a, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x43, 0x61, 0x72, 0x64,
	0x12, 0x19, 0x2e, 0x73, 0x74, 0x72, 0x69, 0x70, 0x65, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
...
var file_proto_stripe_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_proto_stripe_proto_goTypes = []interface{}{
	...
	(*Event)(nil),                         // 9: stripe.Event
	(*ChargeSuceededEvent)(nil),           // 10: stripe.ChargeSuceededEvent
}
var file_proto_stripe_proto_depIdxs = []int32{
	4,  // 0: stripe.ListCardsResponse.cards:type_name -> stripe.Card
	10, // 1: stripe.Event.charge_succeeded:type_name -> stripe.ChargeSuceededEvent
	...
	7,  // 5: stripe.Stripe.DeleteCard:input_type -> stripe.DeleteCardRequest
	1,  // 6: stripe.Stripe.CreateCheckoutSession:output_type -> stripe.CreateCheckoutSessionResponse
	3,  // 7: stripe.Stripe.ListCards:output_type -> stripe.ListCardsResponse
	6,  // 8: stripe.Stripe.ChargeCard:output_type -> stripe.ChargeCardResponse
	8,  // 9: stripe.Stripe.DeleteCard:output_type -> stripe.DeleteCardResponse
