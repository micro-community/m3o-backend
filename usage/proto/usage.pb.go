...
var file_proto_usage_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x32, 0x93, 0x03, 0x0a, 0x05, 0x55, 0x73, 0x61, 0x67, 0x65, 0x12, 0x31,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x75, 0x73, 0x61, 0x67, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_proto_usage_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_proto_usage_proto_goTypes = []interface{}{
	...
	nil,                            // 17: usage.ReadResponse.UsageEntry
	(*structpb.Struct)(nil),        // 18: google.protobuf.Struct
}
var file_proto_usage_proto_depIdxs = []int32{
	2,  // 0: usage.UsageHistory.records:type_name -> usage.UsageRecord
	17, // 1: usage.ReadResponse.usage:type_name -> usage.ReadResponse.UsageEntry
	18, // 2: usage.Event.record:type_name -> google.protobuf.Struct
	...
	1,  // 8: usage.ReadResponse.UsageEntry.value:type_name -> usage.UsageHistory
	0,  // 9: usage.Usage.Read:input_type -> usage.ReadRequest
	4,  // 10: usage.Usage.Sweep:input_type -> usage.SweepRequest
	6,  // 11: usage.Usage.DeleteCustomer:input_type -> usage.DeleteCustomerRequest
	9,  // 12: usage.Usage.SaveEvent:input_type -> usage.SaveEventRequest
	11, // 13: usage.Usage.ListEvents:input_type -> usage.ListEventsRequest
	13, // 14: usage.Usage.ListAPIRanks:input_type -> usage.ListAPIRanksRequest
	3,  // 15: usage.Usage.Read:output_type -> usage.ReadResponse
	5,  // 16: usage.Usage.Sweep:output_type -> usage.SweepResponse
	7,  // 17: usage.Usage.DeleteCustomer:output_type -> usage.DeleteCustomerResponse
	10, // 18: usage.Usage.SaveEvent:output_type -> usage.SaveEventResponse
	12, // 19: usage.Usage.ListEvents:output_type -> usage.ListEventsResponse
	14, // 20: usage.Usage.ListAPIRanks:output_type -> usage.ListAPIRanksResponse
