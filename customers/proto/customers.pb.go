...
var file_proto_customers_proto_rawDesc = []byte{
	...
	0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x67, 0x0a, 0x05, 0x54,
	...
	0x70, 0x69, 0x72, 0x79, 0x22, 0x37, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x26, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
	0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x0f, 0x0a,
	...
	0x32, 0x8c, 0x05, 0x0a, 0x09, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x12, 0x3f,
	...
	0x13, 0x5a, 0x11, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x63, 0x75, 0x73, 0x74, 0x6f,
...
var file_proto_customers_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
...
var file_proto_customers_proto_depIdxs = []int32{
	...
	18, // 4: customers.LoginResponse.token:type_name -> customers.Token
	0,  // 5: customers.Customers.Create:input_type -> customers.CreateRequest
	7,  // 6: customers.Customers.MarkVerified:input_type -> customers.MarkVerifiedRequest
	5,  // 7: customers.Customers.Read:input_type -> customers.ReadRequest
	3,  // 8: customers.Customers.Delete:input_type -> customers.DeleteRequest
	9,  // 9: customers.Customers.List:input_type -> customers.ListRequest
	11, // 10: customers.Customers.Update:input_type -> customers.UpdateRequest
	13, // 11: customers.Customers.Ban:input_type -> customers.BanRequest
	15, // 12: customers.Customers.Unban:input_type -> customers.UnbanRequest
	17, // 13: customers.Customers.Login:input_type -> customers.LoginRequest
	20, // 14: customers.Customers.Logout:input_type -> customers.LogoutRequest
	1,  // 15: customers.Customers.Create:output_type -> customers.CreateResponse
	8,  // 16: customers.Customers.MarkVerified:output_type -> customers.MarkVerifiedResponse
	6,  // 17: customers.Customers.Read:output_type -> customers.ReadResponse
	4,  // 18: customers.Customers.Delete:output_type -> customers.DeleteResponse
	10, // 19: customers.Customers.List:output_type -> customers.ListResponse
	12, // 20: customers.Customers.Update:output_type -> customers.UpdateResponse
	14, // 21: customers.Customers.Ban:output_type -> customers.BanResponse
	16, // 22: customers.Customers.Unban:output_type -> customers.UnbanResponse
	19, // 23: customers.Customers.Login:output_type -> customers.LoginResponse
	21, // 24: customers.Customers.Logout:output_type -> customers.LogoutResponse
